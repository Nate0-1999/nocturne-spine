...
4. **The Injection Console** [console core M2K; audition + what-if M2P]
   ...
   M2P). FORCE (owner, v2.43): any set may be committed regardless of
   its backtest — delta shown honestly, force journaled — because
